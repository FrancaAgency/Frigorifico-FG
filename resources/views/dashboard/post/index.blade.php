...
@section('content')
<a href="{{ route('post.create') }}" class="btn btn-success mt-3 mb-3"> Crear nuevo post</a>
<table class="table  table-striped">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="{{ route('post.show',$i->id) }}" class="btn btn-info">
            ...
            <td> 
                <a href="{{ route('post.edit',$i->id) }}" class="btn btn-warning">
