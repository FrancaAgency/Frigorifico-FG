...
@section('content')
<a href="{{ route('category.create') }}" class="btn btn-success mt-3 mb-3"> Crear nueva categoria </a>
<table class="table  table-striped">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="{{ route('category.show',$i->id) }}" class="btn btn-info">
            ...
            <td> 
                <a href="{{ route('category.edit',$i->id) }}" class="btn btn-warning">
