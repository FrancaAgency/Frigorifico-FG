...
class PostController extends Controller
{
    ...
    public function create()
    {
        ...
        return view ('dashboard.post.create',['post' => new Post() , 'categorias' => $categories]);
    }
    ...
    public function store(StorePostPost $request)
    {
        ...
        return back()->with('status','Datos ingresados correctamente');
    }
    ...
    {
        $categories = Category::pluck('id','title');
        return view('dashboard.post.edit',['post' => $post , 'categorias' => $categories]);
    }
    ...
    public function image(Request $request,Post $post)
    {
       ...
       PostImage::create(['image' => $filaname , 'post_id' => $post->id]);
